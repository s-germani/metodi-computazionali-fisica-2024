...
################################### Dati Input  ##########################################
## Lettura file
exofile = 'https://raw.githubusercontent.com/s-germani/metodi-computazionali-fisica-2024/refs/heads/main/dati/moduli_scientifici/ExoplanetsPars_2024.csv'
#exofile = 'ExoplanetsPars_2024.csv'
...
plt.xlabel('Period [days]',                        fontsize=16)
plt.ylabel(r'(Planet Mass)$^2$/T [$m_J^2/days$]',  fontsize=16)
plt.xscale('log')
plt.yscale('log')
plt.xticks(fontsize=14)
plt.yticks(fontsize=14)
